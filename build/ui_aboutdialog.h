...
"Copyright &copy; 2011-YYYY The Bapcoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bapcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bapcoin</b> version", 0));
