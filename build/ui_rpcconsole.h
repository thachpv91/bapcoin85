...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Bapcoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Bapcoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Bapcoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Bapcoin-Qt help message to get a list with possible Bapcoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
