...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bapcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bapcointools.com", "dnsseed.bapcointools.com"},
    {"bapcoinpool.org", "dnsseed.bapcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"bapcointools.com", "testnet-seed.bapcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bapcoin is probably already running."), addrBind.ToString().c_str());
        else
